# Generated by Django 5.2 on 2025-05-02 20:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('bug', 'Bug'), ('feature', 'Feature'), ('other', 'Other')], default='other', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='Ticket.ticket')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('permissions', models.ManyToManyField(related_name='users', to='Ticket.custompermission')),
                ('roles', models.ManyToManyField(related_name='users', to='Ticket.role')),
